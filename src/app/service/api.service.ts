...
export class ApiService {
  ...
  getTrendingCurrency(currency:String){
    return this.http.get<any>(`https://api.coingecko.com/api/v3/coins/markets?vs_currency=${currency}&order=gecko_desc&per_page=10&page=1&parkline=false&price_change_percentage=24h`)
  }
